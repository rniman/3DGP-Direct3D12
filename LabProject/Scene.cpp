...
void CScene::CreateShaderVariables(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	m_pd3dcbMaterials = ::CreateBufferResource(pd3dDevice, pd3dCommandList, nullptr, ncbMaterialBytes, D3D12_HEAP_TYPE_UPLOAD,	D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, nullptr);
...
void CScene::UpdateObjects(float fTimeElapsed)
{
	for (int i = 0; i < m_nShaders; i++)
	{
		m_pShaders[i].UpdateObjects(fTimeElapsed);
	}
